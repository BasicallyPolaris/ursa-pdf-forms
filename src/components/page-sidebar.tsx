...
import { PAGE_SIDEBAR_WIDTH_CLASS } from "@/lib/shell-layout";
...
export function PageSidebar() {
  ...
  return (
    <aside
      ...
      className={`flex ${PAGE_SIDEBAR_WIDTH_CLASS} shrink-0 flex-col border-r border-border bg-card select-none`}
    >
